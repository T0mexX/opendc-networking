 ...
 * @property[numConsumingFlows]          The number of flows that are being consumed by the node at the instant the snapshot was taken.
    ...
    public companion object {
        ...
        internal fun Node.snapshot(instant: Instant, withStableNetwork: Network? = null): NodeSnapshot {
            ...
            return NodeSnapshot(
                node = this,
                instant = instant,
                numIncomingFlows = fh.consumingFlows.size + fh.outgoingFlows.size - fh.generatedFlows.size,
                numOutgoingFlows = fh.outgoingFlows.size,
                numGeneratedFlows = fh.generatedFlows.size,
                numConsumingFlows = fh.consumingFlows.size,
