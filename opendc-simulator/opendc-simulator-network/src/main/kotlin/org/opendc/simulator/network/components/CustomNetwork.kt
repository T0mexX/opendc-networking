...
internal class CustomNetwork(
    ...
    /**
     * Removes a node from the network, and all its generated [EndToEndFlow]s.
     */
    ...
    /**
     * Removes all [EndToEndFlow]s generated by node with id [nodeId].
     */
    private fun rmEtoEFlowsGenBy(nodeId: NodeId) {
        val flowsTOBeRemoved: Map<FlowId, EndToEndFlow> =
            endToEndFlows.filter { it.value.senderId == nodeId }
